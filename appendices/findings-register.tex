...
\begin{longtable}{@{}p{0.17\widetablewidth}p{0.3\widetablewidth}p{0.075\widetablewidth}p{0.075\widetablewidth}p{0.10\widetablewidth}p{0.13\widetablewidth}p{0.09\widetablewidth}@{}}
...
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.17\widetablewidth}>{\raggedright\arraybackslash}p{0.26\widetablewidth}>{\raggedright\arraybackslash}p{0.53\widetablewidth}@{}}
...
~\cite{h5lens-issue-87,hdf5-assert-build-config-2026,
...
state the scenario and estimate impact and exposure provisionally. It is not evidence

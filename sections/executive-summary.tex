...
file and may cause data loss. & Safety & \emph{None} & NE &
Evidence action (\code{RM-2D}) & \code{CORE} \\
...
Twelve formal findings are registered: seven Rated, four Provisional, and one
NE. Their tiers comprise one Critical, four High, two Moderate--High ranges,
four Moderate, and one finding without an assigned tier. Three further
observations remain in the evidence-and-scoping backlog below the rule in the
table. \textbf{An NE or backlog record is an evidence gap, not a

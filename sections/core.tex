...
Parser normalization is a central recommendation: decode file bytes into a
...
\subsubsection*{Recommendation CORE-S0: Stop closing CVEs as “fixed” unless the class is killed}
...
\caption{Structure-aware fuzzing implementation sequence}
...
\caption[]{Structure-aware fuzzing implementation sequence, continued}\\
\hline
\textbf{Order} & \textbf{Fuzz target} & \textbf{Why first} \\
\hline
\endhead
...
describe corresponding mitigation strategies.

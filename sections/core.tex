...
H5Lens / \code{hdf5-pickles} already provides machine-readable format
...
\cite{hdf5-pickles,h5policy,h5policy-invariant-registry,h5patch}. Its strategy
...
\subsubsection{Core Security Control Programme}
...
\setlength{\LTleft}{-0.9in}
\setlength{\LTright}{-0.9in}
\begin{longtable}{@{}>{\raggedright\arraybackslash}p{0.09\widetablewidth}>{\raggedright\arraybackslash}p{0.25\widetablewidth}>{\raggedright\arraybackslash}p{0.45\widetablewidth}>{\raggedright\arraybackslash}p{0.17\widetablewidth}@{}}

...
\begin{description}
    ...
    \item[h5lens / H5Lens] Machine-readable format definitions with an
...
The candidate \code{h5lens} foundation is GPLv3 while HDF5 is BSD-style;
...
only through an explicit governance decision~\cite{h5lens}.
...
existing \code{h5lens} work is a candidate foundation and an independent
implementation in its own right rather than only a fixture
generator~\cite{h5lens}.
...
The machine-readable specification project \code{h5lens} is a natural
source for generating and checking these fixtures~\cite{h5lens}, and
